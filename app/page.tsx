...
const NotebookContent = ({ userVocab }) => {
  ...
  const vocabItems = sourceList.filter(item => {
      ...
      // CORRECTION ICI : On utilise 'includes' au lieu de '==='
      // Cela permet de filtrer "Verbe", "Verbe régulier", "Verbe -AR", etc.
  ...
  // --- FIN DU BLOC ---
  const grammarItems = sourceList // Note: j'ai remis sourceList ici pour être cohérent avec la sécurité
